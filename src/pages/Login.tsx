...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden">
      ...
      {/* Background */}
      <div className="absolute top-0 left-0 w-full h-64 sm:h-80 md:h-96 bg-primary-900 rounded-b-[40px] sm:rounded-b-[80px] md:rounded-b-[100px] shadow-2xl transition-all duration-500"></div>
      <div className="absolute -top-10 sm:-top-20 -right-10 sm:-right-20 w-64 sm:w-96 h-64 sm:h-96 bg-primary-600 rounded-full blur-2xl sm:blur-3xl opacity-50 transition-all duration-500"></div>
      <div className="absolute top-20 sm:top-40 -left-10 sm:-left-20 w-48 sm:w-72 h-48 sm:h-72 bg-emerald-500 rounded-full blur-2xl sm:blur-3xl opacity-30 transition-all duration-500"></div>
      ...
      <div className="w-full max-w-[420px] bg-white/70 dark:bg-slate-900/80 backdrop-blur-md border border-white/60 dark:border-slate-700/50 rounded-2xl sm:rounded-[2rem] shadow-2xl overflow-hidden relative z-10 transition-all duration-500 mt-12 sm:mt-0">
        ...
        <div className="p-6 sm:p-8 pt-4 sm:pt-4 bg-white/80 dark:bg-slate-900/60">
          {error && (
          ...
          <form onSubmit={handleLogin} className="space-y-4 sm:space-y-5">
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-10 sm:pl-11 pr-4 py-3 sm:py-3.5 input-field border-2 rounded-xl focus:outline-none focus:ring-0 focus:border-primary-500 trans-all text-sm font-medium"
            ...
            <button
              ...
              className="w-full group flex items-center justify-center gap-2 bg-primary-900 text-white font-bold py-3.5 sm:py-4 rounded-xl hover:bg-primary-800 shadow-lg shadow-primary-900/30 trans-all disabled:opacity-70 mt-4 sm:mt-6 active:scale-[0.98] text-sm sm:text-base"
            >
