  ...
  const handleDownloadPDF = async () => {
    ...
    const docDefinition: any = {
      ...
      content: [
        ...
        calloutBox('PENTING: Pengisian Harga Beli', 'Harga Beli wajib diisi dengan benar. Sistem menggunakan angka ini untuk menghitung Harga Pokok Penjualan (HPP) secara otomatis saat barang terjual di Kasir. Jika Harga Beli dibiarkan 0, maka HPP tidak akan tercatat dan Laba di laporan keuangan menjadi tidak akurat.', 'warning'),
